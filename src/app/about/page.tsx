      ...
      <article>
        ...
        <section id='usage'>
          ...
          <p className='mt-4 text-lg text-foreground'>
            ...
            <Link size='lg' href='/recommendations'>
              Recommendations
            </Link>{' '}
            page.
          </p>
        ...
        <section>
          ...
          <p className='mt-4 text-lg text-foreground'>
            ...
            proccess failed. The more common reason for this is that you have
            set your API key incorrectly.
          </p>
          <p className='mt-4 text-lg text-foreground'>
          ...
          <p className='mt-4 text-lg text-foreground'>
            ...
            details could not be loaded correctly. This is usually due that the
